...
第 2 条（個人情報の収集方法）  
管理者は、ユーザーが利用登録をする際にユーザー名、メールアドレス、言語設定、アバター画像URLを含む個人情報をお尋ねすることがあります。  
...
export default function PrivacyPolicyTaskTrees() {
  return (
    <>
      <Card sx={{ p: 2, marginY: 4, backgroundColor: 'rgba(50, 50, 50, 0.5)', backdropFilter: 'blur(10px)' }}>
        <Typography variant='h5'>TaskTrees - プライバシーポリシー</Typography>
        <Divider sx={{ mb: 2 }} />

export const en = {
  meta: {
    description: 'Jun Murakami (Jun Takahashi) is a music director/producer. This site distributes applications and music production libraries I have developed.',
  },
  intro: {
  ...
  apps: {
    wlsib: {
      ...
      description: 'A helpful app for deciding which lenses to take when shooting, traveling, or attending events.',
      longDescription: 'A helpful app for deciding which lenses to take when shooting, traveling, or attending events. You can visually simulate how shooting results will change by setting various shooting conditions. iOS and Android versions are also available.',
    },
    aiBrowser: {
      title: 'AI-Browser',
      description: 'A dedicated chat AI browser supporting ChatGPT, Google Gemini, Claude, and more.',
    ...
    monacoNotepad: {
      ...
      description: 'An app that\'s like Evernote, VSCode, and Notepad combined and divided by about 10.',
    ...
    yomigana: {
      ...
      description: 'A lyrics input support tool for vocalist melody scores (so-called "melo-fu").',
    ...
    dropboxSkipper: {
      ...
      description: 'An app that allows you to set bulk exclusions for Dropbox with specified conditions.',
    ...
    taskTrees: {
      title: 'TaskTrees',
      description: 'An app where you can freely create and organize tasks and memos in a tree format.',
      longDescription: 'An app where you can freely create and organize tasks and memos in a tree format. You can also share trees with others. iOS and Android versions have been released.',
    },
    cubaseDMEditor: {
      title: 'Cubase DrumMap Editor',
      description: 'A simple drum map editor for Cubase.',
      longDescription: 'A simple drum map editor for Cubase. It supports .csv import and export, allowing editing in other software (like Excel). It\'s also suitable for sound source developers. As a bonus, I\'ve created a variety of sound source drum maps that can be used by switching between multiple sound sources in one map.',
    },
    famitone: {
      title: 'Famitone 2A03',
      description: 'A KONTAKT sound library sampled from actual Famicom hardware.',
      longDescription: 'A KONTAKT sound library sampled from actual Famicom hardware.',
    },
  },
  common: {
    download: 'here',
